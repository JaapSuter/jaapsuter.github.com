    ...
    $testFontLoaded$$ = function $$testFontLoaded$$$() {
      if($fallback$$.offsetWidth !== $loaded$$.offsetWidth) {
        if(0 === $repeats_until_valid$$--) {
          return console.log("Ok " + $family$$5$$), $complete$$($JSCompiler_alias_TRUE$$, $family$$5$$)
        }
        console.log("Almost " + $family$$5$$);
        return $util$$.$soon$($testFontLoaded$$)
      }
      if(0 === $attempts$$--) {
        return console.log("Timeout and Failed " + $family$$5$$), $complete$$($JSCompiler_alias_FALSE$$, $family$$5$$)
      }
      console.log("Taking a while " + $family$$5$$);
      return $util$$.$delay$(40, $testFontLoaded$$)
    };
...
(function($global$$5$$, $exports$$5$$) {
  var $body$$1$$, $doc$$1$$, $gatherCss$$, $html$$, $matchesSelector$$, $specificity$$, $_crawl$$, $__indexOf$$2$$ = [].indexOf || function($item$$2$$) {
  ...
  $doc$$1$$ = document;
  $body$$1$$ = $doc$$1$$.body;
  $html$$ = $doc$$1$$.documentElement;
  $exports$$5$$.create = function $$exports$$5$$$create$($tag$$, $innerHTML$$) {
    var $elem$$1$$;
    $elem$$1$$ = $doc$$1$$.createElement($tag$$);
  ...
  $exports$$5$$.$crawl$ = function $$exports$$5$$$$crawl$$($docFun$$, $doneFun$$) {
    return $_crawl$$($docFun$$, $doneFun$$, $doc$$1$$, [$doc$$1$$.location.href.replace(/#.*/, "")])
  };
  $_crawl$$ = function $$_crawl$$$($docFun$$1$$, $doneFun$$1$$, $doc$$2$$, $visited$$, $visits$$, $iframe$$) {
    var $a$$, $href$$, $_i$$10$$, $_len$$7$$, $_ref$$5$$;
    $visits$$ == $JSCompiler_alias_NULL$$ && ($visits$$ = []);
    $iframe$$ == $JSCompiler_alias_NULL$$ && ($iframe$$ = $JSCompiler_alias_NULL$$);
    $docFun$$1$$($doc$$2$$);
    $iframe$$ || ($iframe$$ = $doc$$2$$.createElement("iframe"), $iframe$$.className = "hidden", $body$$1$$.insertBefore($iframe$$, $body$$1$$.firstChild));
    $_ref$$5$$ = $doc$$2$$.querySelectorAll("a");
    $_i$$10$$ = 0;
    for($_len$$7$$ = $_ref$$5$$.length;$_i$$10$$ < $_len$$7$$;$_i$$10$$++) {
      $a$$ = $_ref$$5$$[$_i$$10$$], $href$$ = $a$$.href.replace(/#.*/, ""), 0 <= $__indexOf$$2$$.call($visits$$, $href$$) || 0 <= $__indexOf$$2$$.call($visited$$, $href$$) || $href$$.match(/\.[^.]{0,5}/) || $a$$.host !== $doc$$2$$.location.host || $visits$$.push($href$$)
    }
    if($visits$$.length) {
      return $href$$ = $visits$$.pop(), $visited$$.push($href$$), $iframe$$.onload = function $$iframe$$$onload$() {
        return $_crawl$$($docFun$$1$$, $doneFun$$1$$, $iframe$$.$contentdoc$, $visited$$, $visits$$, $iframe$$)
  ...
  $exports$$5$$.$verifyCss$ = function $$exports$$5$$$$verifyCss$$() {
    var $className$$1_elem$$2_fullName$$, $css$$, $decl_val$$, $hasAtLeastOneStyledPropertyNotFromUniversal$$, $idName_matches$$, $prop$$4$$, $sel$$, $sels$$, $specificity$$1$$, $tagName$$2$$, $_i$$11$$, $_len$$8$$, $_ref$$6$$, $_ref2$$7$$;
    if($matchesSelector$$) {
      $css$$ = $gatherCss$$.apply($JSCompiler_alias_NULL$$, $doc$$1$$.styleSheets);
      $_ref$$6$$ = $doc$$1$$.querySelectorAll("html, body, body *");
      $_i$$11$$ = 0;
...
(function($_ref$$9_global$$6$$) {
  ...
  $diagnose$$ = function $$diagnose$$$() {
    ...
    $ppgd$$ = parseFloat(window.getComputedStyle($body$$2$$).lineHeight);
